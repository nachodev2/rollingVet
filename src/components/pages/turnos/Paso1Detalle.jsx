...
const Paso1Detalle = ({ datos, setDatos, siguiente }) => {
    ...
    const [mascota, setMascota] = useState(datos.mascota || { 
        nombre: '', 
        especie: '', 
        raza: '', 
        edad: '' 
    ...
    const handleSubmit = (e) => {
        ...
        if (!detalleCita || !mascota.nombre || !mascota.especie || !mascota.raza || !mascota.edad) {
        ...
        <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-4" controlId="formDetalleCita">
                ...
                <Form.Control
                    as="textarea"
                    rows={3}
                    placeholder="Describe el motivo de la consulta (ej: Vacunación anual, chequeo de tos, control post-operatorio, etc.)"
                    value={detalleCita}
